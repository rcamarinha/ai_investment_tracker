/**
 * Shared utilities for the Bank Holdings module.
 *
 * Deliberately self-contained — a copy rather than an import, so this module
 * stays independently extractable, same reasoning as spend/utils.js.
 */
...
/** Deterministic colour per holding type, so the list reads at a glance. */
const TYPE_COLOURS = {
    bond: '#7FA6E0', fund: '#5BC4A8', deposit: '#C9A84C',
    structured: '#C77DBB', other: '#9A95A0'
};
export function typeColour(type) { return TYPE_COLOURS[type] || TYPE_COLOURS.other; }
