...
export const TRANSLATIONS = {
    en: {
        ...
        'nav.spend':        '💸 Spend',
        'nav.holdings':     '🏦 Bank',
        'hold.title':           'Bank Holdings',
        'hold.subtitle':        "What your banks hold that the markets don't quote",
        'hold.list':            'Holdings',
        'hub.hold_eyebrow':     'Bonds · Funds · Deposits',
        'hub.hold_title':       'Bank Holdings',
        'hub.hold_f1':          'Bonds and investment funds',
        'hub.hold_f2':          'Valued from your statements',
        'hub.hold_f3':          'Counts toward net worth',
        'hub.hold_cta':         'Open Bank Holdings →',
        'hub.spend_eyebrow':    'Cash Flow · Scenarios',
        'hub.spend_title':      'Spend',
        'hub.spend_f1':         'Multi-bank statement import',
        'hub.spend_f2':         'Year-on-year comparison',
        'hub.spend_f3':         'What-if scenarios',
        'hub.spend_cta':        'Open Spend →',
        'spend.title':          'Spend',
        'spend.subtitle':       'Where the money goes — and what changes if you change it',
        'spend.categories':     'Where it went',
        'spend.categories_manage':  'Categories',
        'spend.trend':          'Evolution',
        'spend.recurring':      'Recurring',
        'spend.simulator':      'What if…',
        'spend.accounts':       'Accounts',
        'spend.transactions':   'Transactions',
        'spend.import':         'Import',
        'nav.login':        'Login',
        'nav.logout':       'Logout',
        ...
        'auth.set_password':    'Choose a password',
        'auth.new_password_ph': 'Password',
        'auth.confirm_ph':      'Confirm password',
        'auth.set_btn':         'Set Password',
        'auth.cancel':          'Cancel',
        'auth.invite_only':     'New accounts are by invitation.',
        'auth.invite_hint':     'Invited but never chose a password? Use Forgot password.',
        'auth.link_expired':    'This link has expired or was already used. Ask for a new invitation, or use Forgot password.',
        'auth.link_failed':     'That sign-in link did not work. Try again, or use Forgot password.',
        ...
        'hub.subtitle':         'Stocks, bank holdings, wine and spending — one private view of where you stand',
    ...
    pt: {
        ...
        'nav.spend':        '💸 Gastos',
        'nav.holdings':     '🏦 Banco',
        'hold.title':           'Aplicações Bancárias',
        'hold.subtitle':        'O que os seus bancos detêm e os mercados não cotam',
        'hold.list':            'Aplicações',
        'hub.hold_eyebrow':     'Obrigações · Fundos · Depósitos',
        'hub.hold_title':       'Aplicações Bancárias',
        'hub.hold_f1':          'Obrigações e fundos de investimento',
        'hub.hold_f2':          'Valorizadas pelos seus extratos',
        'hub.hold_f3':          'Contam para o património',
        'hub.hold_cta':         'Abrir Aplicações →',
        'hub.spend_eyebrow':    'Fluxo de Caixa · Cenários',
        'hub.spend_title':      'Gastos',
        'hub.spend_f1':         'Importar extratos de vários bancos',
        'hub.spend_f2':         'Comparação homóloga',
        'hub.spend_f3':         'Cenários hipotéticos',
        'hub.spend_cta':        'Abrir Gastos →',
        'spend.title':          'Gastos',
        'spend.subtitle':       'Para onde vai o dinheiro — e o que muda se o mudares',
        'spend.categories':     'Para onde foi',
        'spend.categories_manage':  'Categorias',
        'spend.trend':          'Evolução',
        'spend.recurring':      'Recorrentes',
        'spend.simulator':      'E se…',
        'spend.accounts':       'Contas',
        'spend.transactions':   'Transações',
        'spend.import':         'Importar',
        'nav.login':        'Entrar',
        'nav.logout':       'Sair',
        'nav.lang_switch':  'EN',
        ...
        'auth.set_password':    'Escolher uma senha',
        'auth.new_password_ph': 'Senha',
        'auth.confirm_ph':      'Confirmar senha',
        'auth.set_btn':         'Definir Senha',
        'auth.cancel':          'Cancelar',
        'auth.invite_only':     'Novas contas apenas por convite.',
        'auth.invite_hint':     'Convidado mas sem senha? Use Esqueci a senha.',
        'auth.link_expired':    'Este link expirou ou já foi usado. Peça um novo convite, ou use Esqueci a senha.',
        'auth.link_failed':     'Esse link de acesso não funcionou. Tente de novo, ou use Esqueci a senha.',
        ...
        'hub.subtitle':         'Ações, aplicações bancárias, vinho e gastos — uma visão privada de onde está',
