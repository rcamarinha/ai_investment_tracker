...
const state = {
    ...
    posSearch: '',             // positions toolbar: text search over symbol + name
    posSort: 'value',          // positions toolbar: value | gain | loss | name | symbol
    cardTxExpanded: null,      // Set of symbols whose card transaction panel is expanded (lazily created)
    _ledgerRows: [],           // transient: rows shown in expanded card tx panels (for index-based delete)
