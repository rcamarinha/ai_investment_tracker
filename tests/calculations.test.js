...
describe('calculateRemainingRatio', () => {
  ...
  it('returns 0.5 when half the shares are sold', () => {
    ...
    // After sell: 50 shares, avgPrice still 100 → investedNative = 5000
  ...
  it('returns 1 after a stock split (not inflated by extra shares)', () => {
    ...
    // After 4:1 split: 400 shares, avgPrice = 25, cost still 10000
  ...
  it('returns 0.75 after split + partial sell', () => {
    ...
    // After split: 400 shares @ 25, sell 100 → 300 shares @ 25, cost = 7500
  ...
  it('handles multiple buys at different prices + partial sell', () => {
    ...
    // After buys: 200 shares, cost = 22000, avg = 110
    // After sell 100: 100 shares, cost = 11000, avg = 110
